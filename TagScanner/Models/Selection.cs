namespace TagScanner.Models
{
    ...
    public class Selection : ITrack
    {
        ...
        public Selection(IEnumerable<Track> files) => Tracks = files;
        ...
        public long FileSize => GetLong(p => p.FileSize, ref _fileSize, true);//return Files.Sum(f => f.FileSize);
        ...
        private const TagLib.MediaTypes AllMediaTypes = (TagLib.MediaTypes)15;
