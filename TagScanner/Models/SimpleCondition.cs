    ...
    public class SimpleCondition
    {
        ...
        private object Value
        {
            get
            {
                ...
                {
                    case "DateTime": return DateTime.Parse(ValueString);
                    case "Int32": return Convert.ToInt32(ValueString);
                    case "Int64": return Convert.ToInt64(ValueString);
                    case "Logical": return ValueString == "true" ? Logical.Yes : Logical.No;
                    case "String": return ValueString;
                    case "TimeSpan": return TimeSpan.Parse(ValueString);
                    default: return null;
                };
            }
        }
        ...
        private static ExpressionType OperatorToExpressionType(string @operator)
        {
            switch (@operator)
            {
                case Operators.Equal: return ExpressionType.Equal;
                case Operators.NotEqual: return ExpressionType.NotEqual;
                case Operators.LessThan: return ExpressionType.LessThan;
                case Operators.NotGreaterThan: return ExpressionType.LessThanOrEqual;
                case Operators.NotLessThan: return ExpressionType.GreaterThanOrEqual;
                case Operators.GreaterThan: return ExpressionType.GreaterThan;
                default: return ExpressionType.Equal;
            };
        }
