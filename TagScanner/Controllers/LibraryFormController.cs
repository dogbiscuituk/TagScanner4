namespace TagScanner.Controllers
{
    ...
    public class LibraryFormController
    {
        ...
        private void EditFind_Click(object sender, EventArgs e) => FindReplaceDialogController.ShowDialog(View, false);

        private void EditReplace_Click(object sender, EventArgs e) => FindReplaceDialogController.ShowDialog(View, true);
        ...
        private void HelpAbout_Click(object sender, EventArgs e) => MessageBox.Show(
                string.Format("{0}\n{1}\nVersion {2}",
        ...
        private void PopupFilters_Click(object sender, EventArgs e) => EditQuery();
        ...
        private List<Track> GetTracks(FileStatus status) => Model.Tracks.Where(track => track.FileStatus == status).ToList();
        ...
        private void EditQuery() => FilterDialogController.ShowDialog(View);
