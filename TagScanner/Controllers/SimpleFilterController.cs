namespace TagScanner.Controllers
{
    ...
    public class SimpleFilterController : FilterController
    {
        ...
        private Control GetValueEdit(string propertyTypeName)
        {
            ...
            {
                case "DateTime": return ValueEditDateTime;
                case "String": return ValueEditText;
                case "Int32": return ValueEditInt;
                case "Int64": return ValueEditLong;
                case "TimeSpan": return ValueEditTime;
                case "Logical": return ValueEditBool;
                default: return null;
            };
        }
