...
namespace TagScanner.Controllers
{
	public class TagSelectorController : IComparer
	{
		...
		private void PopupViewAlphabetical_Click(object sender, EventArgs e)
		{
			SetView(View.Details, false);
		}

		private void PopupViewGrouped_Click(object sender, EventArgs e)
		{
			SetView(View.Details, true);
		}
