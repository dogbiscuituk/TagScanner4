namespace TagScanner.Controllers
{
    ...
    public class LibraryGridController : GridController
    {
        ...
        protected override PropertyInfo[] GetPropertyInfos() => Metadata.TrackPropertyInfos;
        ...
        private void InitFilter() => ListCollectionView.Filter = Filter;
        ...
        private Selection GetSelection() => new Selection(DataGrid.SelectedItems.Cast<Track>());
        ...
        public void ViewByAlbum() => SetQuery(VisibleTagsDefault, new[] { "Album" }, new[] { "Disc", "Track" });

        public void ViewByArtist() => SetQuery(new[] { "YearAlbum", "DiscTrack", "Title", "Duration", "FileSize" }, new[] { "JoinedPerformers" }, new[] { "Disc", "Track" });

        public void ViewByArtistAlbum() => SetQuery(VisibleTagsDefault, new[] { "JoinedPerformers", "YearAlbum" }, new[] { "Disc", "Track" });

        public void ViewByGenre() => SetQuery(VisibleTagsDefault, new[] { "JoinedGenres", "JoinedPerformers", "YearAlbum" }, new[] { "Disc", "Track" });

        public void ViewByNone() => SetQuery(VisibleTagsExtended, new string[0], new[] { "Disc", "Track" });

        public void ViewByYear() => SetQuery(VisibleTagsExtended, new[] { "Decade", "Year" }, new[] { "Disc", "Track" });
